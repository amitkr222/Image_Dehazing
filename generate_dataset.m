...
% Set up directory
root_dir = '\Users\Sumit\Downloads\4KDehazing-main\4KDehazing-main\datagen';
image_dir = [root_dir, filesep, 'RaindropGroundtruth', ];
depth_dir = [root_dir , filesep , 'RaindropDepth'];
...
% Find the difference between loop start and end time and display
elapsed_time = milliseconds(finish - start);
fprintf('The time of execution of the above program is: %.03f ms\n', elapsed_time);
